---
name: us-strategy-us-momo-swing-slow
description: 美股动量轮动（Slow 版，持仓6只）。自动构建候选池，T+1 执行，严格无未来函数。
---
...
```bash
SKILL_DIR="/Users/yanyun/dev/git_repo/ai-stock/ai-stock-data-v2/hk-us-market-skill/us-strategy-us-momo-swing-slow"
