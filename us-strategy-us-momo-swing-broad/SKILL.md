---
name: us-strategy-us-momo-swing-broad
description: 美股广覆盖动量轮动（持仓 8 只），T+1 执行，无未来函数。
---
...
```bash
SKILL_DIR="/Users/yanyun/dev/git_repo/ai-stock/ai-stock-data-v2/hk-us-market-skill/us-strategy-us-momo-swing-broad"
