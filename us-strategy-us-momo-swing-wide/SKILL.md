---
name: us-strategy-us-momo-swing-wide
description: 美股宽持仓动量轮动（持仓 9 只），T+1 执行，无未来函数。
---
...
```bash
SKILL_DIR="/Users/yanyun/dev/git_repo/ai-stock/ai-stock-data-v2/hk-us-market-skill/us-strategy-us-momo-swing-wide"
