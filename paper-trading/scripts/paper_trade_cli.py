#!/usr/bin/env python3
"""CLI entrypoint for HK+US paper trading service."""
...
def request_json(base_url: str, method: str, path: str, payload: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    try:
        ...
        raise RuntimeError(
            ...
            f"{base_url}: {exc}. "
            "Try starting it with: python3 scripts/paper_trading_service.py"
        ) from exc
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Paper trading CLI for hk-us paper trading skill")
